            ...
            <main className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                >
                  ...
                  <h1 className="font-serif text-5xl md:text-7xl font-bold mb-12 border-b-2 border-border pb-8">Beginner Entrepreneur <br/><span className="italic font-light text-muted-foreground">and software Developer.</span></h1>
                  ...
                  <div className="prose prose-lg dark:prose-invert max-w-none space-y-8 text-muted-foreground">
                    ...
                    <p>
                      My philosophy is simple: design is not just about making things look good. It is about distilling complexity into its purest, most potent form. Every line, every shadow, every code must prove its existence in the line.
                    </p>
