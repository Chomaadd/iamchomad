    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          >
            <h1 className="font-serif text-5xl md:text-7xl font-bold mb-12 border-b-2 border-border pb-8">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none space-y-8 text-muted-foreground">
              ...
              <h3 className="font-serif text-2xl text-foreground mt-12 mb-6">
              ...
              <ul className="list-none pl-0 space-y-4 border-l-2 border-primary ml-4 pl-6 mt-8">
                <li>
                  ...
                  — Guiding brand vision from conception to execution.
                </li>
                <li>
                  <strong className="text-foreground">
                    Digital Architecture
                  </strong>{" "}
                  — Structuring complex systems with intuitive grace.
                </li>
                <li>
                  <strong className="text-foreground">Editorial Design</strong>{" "}
                  — Crafting typography-driven narrative experiences.
                </li>
              </ul>
            </div>
          </motion.div>
