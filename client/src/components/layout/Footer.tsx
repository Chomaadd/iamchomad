export function Footer() {
  return (
    <footer className="border-t-2 border-border bg-background py-12 md:py-16 mt-20">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 mt-12 text-center md:text-left text-xs text-muted-foreground">
        &copy; {new Date().getFullYear()} Elegance Portfolio. All rights reserved.
      </div>
    </footer>
  );
}
