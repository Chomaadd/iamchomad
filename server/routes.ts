...
export async function registerRoutes(
  ...
  app.put("/api/love/config", requireAuth, async (req, res) => {
    try {
      ...
      console.log("[love/config PUT] photos len:", body.lovePhotos?.length, "quiz len:", body.loveQuiz?.length, "musicUrl:", body.loveMusicUrl, "startTime:", body.loveMusicStartTime, "endTime:", body.loveMusicEndTime);
